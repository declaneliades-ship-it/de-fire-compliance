    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#1e293b">
          ...
          <p style="font-size:15px;line-height:1.7;color:#475569">We've received your quote request and will be in touch within <strong>24 hours</strong> with a full written quote${estimatedPrice ? ' confirming this estimate' : ''} and a <strong>sample inspection report</strong> so you can see exactly what our deliverables look like.</p>
          ${estimatedPrice ? `<div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:16px 20px;margin:16px 0"><p style="margin:0 0 8px;font-size:14px;font-weight:600;color:#1e293b">What affects the final price?</p><ul style="margin:0;padding:0 0 0 18px;font-size:13px;color:#64748b;line-height:1.8"><li>Number and distribution of doors across floors</li><li>Site access arrangements (keys, fobs, occupied units)</li><li>Building layout and complexity</li><li>Whether doors are in communal or private areas</li><li>Multi-site programme discounts for larger portfolios</li></ul></div>` : ''}
          ...
          <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 18px;margin:16px 0"><p style="margin:0 0 4px;font-size:14px;font-weight:600;color:#b91c1c">Free on-site sample inspection</p><p style="margin:0;font-size:13px;color:#64748b;line-height:1.6">We offer a free, no-obligation sample inspection of up to 5 fire doors so you can see exactly how we work before committing. Just reply to this email or mention it when we speak.</p></div>
          <p style="font-size:14px;color:#475569;margin-top:20px"><strong>Most clients at this stage book a quick call</strong> to confirm details and lock in a date. Reply to this email or call us directly:</p>
          <hr style="border:none;border-top:1px solid #e2e8f0;margin:24px 0">
          <p style="font-size:14px;color:#475569">Email: <strong><a href="mailto:info@defirecompliance.co.uk" style="color:#b91c1c">info@defirecompliance.co.uk</a></strong><br>Phone: <strong><a href="tel:+447770871782" style="color:#b91c1c">+44 7770 871782</a></strong></p>
